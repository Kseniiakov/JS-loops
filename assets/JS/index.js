...
//   for (let factor = 1; factor <= 15; factor += 2) {
//     console.log(num,'+', factor, '=', num+factor);
//   }
// }
...
// let userNum = prompt('введите число звездочек');

// for (let num = '*'; num.length <= userNum; num += '*') {
//   console.log(num);
// }
...
// }
  ...
  // for (let col = 1; col <= myNum; col++) {
    // for (let row = '*'; row.length <= myNum; row += '*') {
      // console.log(result);
  //   }
